...
- [[팔란티어는 무엇을 하는 회사이고 엔비디아와의 계약은 온톨로지로 무엇을 하려는 것인가]] #ai #supply-chain #strategy — 대주제 2개: (1) 팔란티어는 Gotham·Foundry·Apollo·AIP 4개 플랫폼을 파는 '의사결정 실행' 회사이고 이를 관통하는 것이 온톨로지 — 공식 정의로 '조직의 디지털 트윈'이며 의미론(객체·속성·링크)·동역학(액션 타입=누가 무엇을 바꿀 수 있는가)·동적 3계층. 시맨틱 레이어가 지표 계산식에 머무는 반면 온톨로지는 실체·관계·규칙·액션까지 모델링해 에이전트가 그래프를 순회하게 한다. 2026 2분기 매출 19.4억 달러(+93%), 미국 상업 +149%, 고객 1,049곳. 밸류에이션 논쟁(버리 풋·배수는 출처마다 상이)과 ICE 감시 논쟁이 따라붙음 (2) 엔비디아 계약은 2025.10.28 최초 발표 + 2026.9.10 공급망 확장 — Nemotron 사후학습·cuOpt 최적화·NeMo 도구군이 Foundry/AIP에 들어가 '온톨로지에 근거'해 작동하고, 첫 적용처가 엔비디아 자신의 공급망(Vera Rubin 랙 1대 130만 부품)의 자재 배분. 금전 조건·지분은 미공개인 제품 통합형 제휴이며 'sovereign'은 독점 데이터 통제권 유지 + 온프레미스/코로케이션 배포(Dell·Cisco·Rackspace·Nebius)를 뜻함. 조합의 논리 = 엔비디아는 연산·모델, 팔란티어는 맥락 구조
