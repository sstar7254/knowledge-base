...
## qa/ — 질문-답변 노트 (파일명 = 질문; /inbox 스킬이 정규화) (13)
...
- [[기업이 시가총액을 키우려는 가장 큰 유인은 무엇인가]] #finance #strategy #macro — 정량 1순위는 주식 기반 보상(S&P 500 CEO LTI의 60%가 성과연동 주식, 상대 TSR 연동), 정성 1순위는 경영권 방어(2025년 행동주의 캠페인 255건 사상 최다·캠페인 1년 내 CEO 사임 32명). 단 한국은 최대주주 상속세 실효 60%가 부호를 뒤집어 왔고, 3차 상법 개정(2026.3 시행)의 자사주 1년 내 소각 의무화가 그 부호를 제도로 고정하는 중
- [[한국 상법 1·2·3차 개정은 무엇을 바꿨고 시가총액에 실제로 어떤 효과를 냈는가]] #finance #strategy #macro — 대주제 2개: (1) 260903 기준 시행 현황 — 1차(이사 충실의무 2025.7.22 즉시·독립이사/3%룰 2026.7.23·전자주총 2027.1.1), 2차(집중투표제 의무화·분리선출 감사위원 2명, 2026.9.10 시행으로 아직 7일 전), 3차(자사주 1년 내 의무소각 2026.3.6 즉시 시행, 기존분 최종기한 2027.9) + 자본시장법 시행령(2026.6.30, 주주균등처분 원칙)·배당소득 분리과세(2026.1.1~2028)·예정된 주가누르기 방지 과세(2027.4) (2) 시총 효과는 지수가 아니라 3개 채널에서만 확인 — 자사주 소각 폭발(SK하이닉스 40조·KB금융 2.3조), 지주사 디스카운트 축소, 이사회 운영 변화(상장사 84.3%). 반증: 코스피 폭등에도 PBR 1배 미만 기업은 541→565곳으로 증가(7월말 802곳 중 600곳=75%), MSCI 관찰대상국 편입 불발(2026.6.23), 기업 53.7%가 소송 리스크 증가 응답
